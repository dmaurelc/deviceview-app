...
const Sidebar = ({ 
  ...
  return (
    <div className={`sidebar fixed top-16 left-0 z-50 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 transition-all duration-300 h-full flex flex-col w-64 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
